...
elif [ "$1"x = "dp300_on_500x" ]; then
    echo "        You build project: DP300_On_500"
    platform="mt6573"
    buildName="dp300_on_500"
    buildPath="source/server_sync/dp300_on_500/"
    Product="dp300_on_500.xml"
    destDir="../dp300_on_500_image"
    ftpPath="/var/ftp/image/dp300_on_500/"

    ftpPath_500b="/var/ftp/image/dp300_on_500B"
    buildName1="dp300_on_500B"
