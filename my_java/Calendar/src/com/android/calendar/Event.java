...
public class Event implements Comparable<Event>, Cloneable {
    ...
    private static final String[] PROJECTION = new String[] {
            ...
            Events.ORIGINAL_EVENT,           // 19 : add for repeat exception event
    };
    ...
    private static final int PROJECTION_ORIGINAL_EVENT = 19;
    ...
    public int mRepeatStatus;
    public static final int REPEAT_NO = 0;
    public static final int REPEAT_NORMAL = 1;
    public static final int REPEAT_EXCEPTION = 2;
        ...
        try {
            ...
            while (c.moveToNext()) {
                ...
                if (!TextUtils.isEmpty(rrule) || !TextUtils.isEmpty(rdate)) {
                    e.mRepeatStatus = REPEAT_NORMAL;
                } else {
                    String originalEvent = c.getString(PROJECTION_ORIGINAL_EVENT);
                    if(!TextUtils.isEmpty(originalEvent)) {
                    	e.mRepeatStatus = REPEAT_EXCEPTION;
                    } else{
                    	e.mRepeatStatus = REPEAT_NO;
                    }
                }
