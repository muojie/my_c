...
public class AgendaWindowAdapter extends BaseAdapter {
    ...
    public static final int INDEX_ORIGINAL_EVENT = 13;
    ...
    private static final String[] PROJECTION = new String[] {
            ...
            Instances.ORIGINAL_EVENT, //13 original event
    };
    ...
    private void doQuery(QuerySpec queryData) {
        if (!mAdapterInfos.isEmpty()) {
            ...
            ///* Check valid range [1970, 2037] */ like month view
            if ((checkTime.year < 1970 || 2037 < checkTime.year || (checkTime.year==2037 && checkTime.month > 11))) {
              ...
              case QUERY_TYPE_NEWER:
                  ...
                  checkTime.year = 2038;
                  checkTime.month = 0;
                  checkTime.monthDay = 0;
                  int julianDay = Time.getJulianDay(checkTime.toMillis(true), 0);
                  
                  if(end < julianDay) {
                      queryData.end = julianDay;
                  } else {
