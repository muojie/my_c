...
public class AgendaAdapter extends ResourceCursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (!TextUtils.isEmpty(rrule)) {
        	...
        	String originalEvent = cursor.getString(AgendaWindowAdapter.INDEX_ORIGINAL_EVENT);
        	if(!TextUtils.isEmpty(originalEvent)) {
                when.setCompoundDrawablesWithIntrinsicBounds(null, null,
                        context.getResources().getDrawable(R.drawable.ic_repeat_dark_exception), null);
        	} else {
