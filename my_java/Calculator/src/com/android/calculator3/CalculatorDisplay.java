...
class CalculatorDisplay extends ViewSwitcher {
    ...
    void insert(String delta) {
        ...
        Editable editableString = editor.getText();
        // if the string on the EditText is "Error", clear it before insert
        if (mLogic.isErrorString(editableString.toString())) {
        	Calculator.log("Display.insert, current string is: " 
        			+ editableString + ", clear it!");
        	editableString.clear();
        }
        int cursor = editor.getSelectionStart();
        editableString.insert(cursor, delta);
    }
